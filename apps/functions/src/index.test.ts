...
describe('functions index', () => {
  it('exports the deployed function set', async () => {
    ...
    expect(typeof mod.rescheduleBooking).not.toBe('undefined');
